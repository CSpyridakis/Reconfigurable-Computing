...
set Library     "hls"
set IPName      "my_ip_hls"
set Version     "1.1"
set DisplayName "My_ip_hls"
set Revision    "1905290955"
...
set Interfaces {
    s_axi_psAxiLite {
        ...
        registers {{0x10 rule0_V W 0x0 "Data signal of rule0_V" {{0 32 rule0_V W 0 "Bit 31 to 0 Data signal of rule0_V"}}} {0x18 rule1_V W 0x0 "Data signal of rule1_V" {{0 32 rule1_V W 0 "Bit 31 to 0 Data signal of rule1_V"}}} {0x20 rule2_V W 0x0 "Data signal of rule2_V" {{0 32 rule2_V W 0 "Bit 31 to 0 Data signal of rule2_V"}}} {0x28 rule0cnt_V R 0x0 "Data signal of rule0cnt_V" {{0 32 rule0cnt_V R 0 "Bit 31 to 0 Data signal of rule0cnt_V"}}} {0x2c rule0cnt_V_ctrl R 0x0 "Control signal of rule0cnt_V" {{0 1 rule0cnt_V_ap_vld R 0 "Control signal rule0cnt_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 rule1cnt_V R 0x0 "Data signal of rule1cnt_V" {{0 32 rule1cnt_V R 0 "Bit 31 to 0 Data signal of rule1cnt_V"}}} {0x34 rule1cnt_V_ctrl R 0x0 "Control signal of rule1cnt_V" {{0 1 rule1cnt_V_ap_vld R 0 "Control signal rule1cnt_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 rule2cnt_V R 0x0 "Data signal of rule2cnt_V" {{0 32 rule2cnt_V R 0 "Bit 31 to 0 Data signal of rule2cnt_V"}}} {0x3c rule2cnt_V_ctrl R 0x0 "Control signal of rule2cnt_V" {{0 1 rule2cnt_V_ap_vld R 0 "Control signal rule2cnt_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"

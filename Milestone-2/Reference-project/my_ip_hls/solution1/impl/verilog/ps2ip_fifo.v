...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_done_reg == 1'b1) | ((tmp_reg_87 == 1'd1) & (ps2ipFifo_V_data_V1_status == 1'b0))) & (1'b1 == ap_CS_iter1_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_reg_87 == 1'd1) & (ps2ipFifo_V_data_V1_status == 1'b0) & (1'b1 == ap_CS_iter1_fsm_state2)) | ((tmp_nbreadreq_fu_40_p5 == 1'd1) & (slaveIn_TVALID == 1'b0))) & (tmp_nbreadreq_fu_40_p5 == 1'd1) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_reg_87 == 1'd1) & (ps2ipFifo_V_data_V1_status == 1'b0) & (1'b1 == ap_CS_iter1_fsm_state2)) | ((tmp_nbreadreq_fu_40_p5 == 1'd1) & (slaveIn_TVALID == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
        tmp_reg_87 <= tmp_nbreadreq_fu_40_p5;
    end
end

always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | ((tmp_reg_87 == 1'd1) & (ps2ipFifo_V_data_V1_status == 1'b0))) & (1'b1 == ap_CS_iter1_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | ((tmp_reg_87 == 1'd1) & (ps2ipFifo_V_data_V1_status == 1'b0))) & (tmp_reg_87 == 1'd1) & (1'b1 == ap_CS_iter1_fsm_state2))) begin
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (tmp_nbreadreq_fu_40_p5 == 1'd1) & (1'b1 == ap_CS_iter0_fsm_state1) & (real_start == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_iter1_fsm)
        ap_ST_iter1_fsm_state2 : begin
            if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_40_p5 == 1'd1) & (slaveIn_TVALID == 1'b0))) & ~((ap_done_reg == 1'b1) | ((tmp_reg_87 == 1'd1) & (ps2ipFifo_V_data_V1_status == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
                ap_NS_iter1_fsm = ap_ST_iter1_fsm_state2;
            end else if ((~((ap_done_reg == 1'b1) | ((tmp_reg_87 == 1'd1) & (ps2ipFifo_V_data_V1_status == 1'b0))) & ((1'b0 == ap_CS_iter0_fsm_state1) | ((1'b1 == ap_CS_iter0_fsm_state1) & ((real_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_40_p5 == 1'd1) & (slaveIn_TVALID == 1'b0))))))) begin
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((real_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_40_p5 == 1'd1) & (slaveIn_TVALID == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((tmp_reg_87 == 1'd1) & (ps2ipFifo_V_data_V1_status == 1'b0));
end
